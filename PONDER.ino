...
#define transistor 8 //MOSFET used to cut power to sensor rail when in deep sleep
...
//-----------------------------------------------------------------------------------------------------------------
void enterSleep(){
  digitalWrite(transistor, LOW); //turns off input to MOSFET gate, thus cutting power to sensor rail
  ...
  digitalWrite(transistor, HIGH); //turns on MOSFET, returning power to sensor rail
